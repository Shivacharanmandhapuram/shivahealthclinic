...
const Services: React.FC = () => {
  return (
    <section id="services" className="py-16 sm:py-24 bg-white scroll-mt-32">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col items-center text-center mb-10 sm:mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-medium text-gray-900 tracking-tight leading-[1.15] max-w-2xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* Card 1: Primary Care */}
            <div className="bg-white p-5 sm:p-8 rounded-[20px] sm:rounded-[32px] border border-gray-100 shadow-[0_2px_20px_rgba(0,0,0,0.04)] hover:shadow-lg transition-shadow duration-300 flex flex-col items-start h-full">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#006d77] rounded-[10px] sm:rounded-[14px] flex items-center justify-center mb-4 sm:mb-6 text-white shrink-0">
                <Heart className="w-5 h-5 sm:w-6 sm:h-6 fill-current" />
              </div>
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">Primary Care</h3>
            ...
            <div className="bg-white p-5 sm:p-8 rounded-[20px] sm:rounded-[32px] border border-gray-100 shadow-[0_2px_20px_rgba(0,0,0,0.04)] hover:shadow-lg transition-shadow duration-300 flex flex-col items-start h-full">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">Pain Management</h3>
              <p className="text-gray-500 leading-relaxed text-sm sm:text-base">
            ...
            <div className="bg-white p-5 sm:p-8 rounded-[20px] sm:rounded-[32px] border border-gray-100 shadow-[0_2px_20px_rgba(0,0,0,0.04)] hover:shadow-lg transition-shadow duration-300 flex flex-col items-start h-full">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">DOT / CDL Physicals</h3>
              <p className="text-gray-500 leading-relaxed text-sm sm:text-base">
            ...
            <div className="bg-white p-5 sm:p-8 rounded-[20px] sm:rounded-[32px] border border-gray-100 shadow-[0_2px_20px_rgba(0,0,0,0.04)] hover:shadow-lg transition-shadow duration-300 flex flex-col items-start h-full">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">Urgent Care & Addiction</h3>
              <p className="text-gray-500 leading-relaxed text-sm sm:text-base">
          ...
          <div className="lg:col-span-1 bg-[#006d77] rounded-[20px] sm:rounded-[32px] p-6 sm:p-8 relative overflow-hidden flex flex-col text-white min-h-[400px] sm:min-h-[500px] lg:min-h-0">
            {/* Background Pattern */}
            ...
            <div className="relative z-10 mb-6 sm:mb-8">
              <h3 className="text-2xl sm:text-3xl font-semibold mb-3 sm:mb-4 leading-tight">Expert care close to home</h3>
              <p className="text-teal-100 text-base sm:text-lg opacity-90 leading-relaxed">
